    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            void one()
            {
                ...
                {
                    Console.WriteLine("\nRavioli: Eat ass!");
                    Console.WriteLine("\nErik: Uhm, Like ok. That was unexpected, why would I do that?");
                    Console.WriteLine("\nHirathak: Hey, can we please just focus on getting down.");
                    one();
                }
                else
                {
            ...
            void fourA()
            {
                ...
                else if (temp == "back" || temp == "go back" || temp == "jump across" || temp == "jump" || temp == "walk east" || temp == "east" || temp == "help")
                {
                    ...
                    {
                        Console.WriteLine("You quickly sprint and jump across the river.");
                    }
                    two();
                }
                else
